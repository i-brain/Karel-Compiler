 ...
 * </p>
 * <ul>
 *   <li>{@link statemachine.model.impl.CounterImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CounterImpl extends NamedElementImpl implements Counter {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.COUNTER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COUNTER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.COUNTER__VALUE:
				return getValue();
		}
