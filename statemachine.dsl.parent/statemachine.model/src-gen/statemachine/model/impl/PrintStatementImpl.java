 ...
 * </p>
 * <ul>
 *   <li>{@link statemachine.model.impl.PrintStatementImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrintStatementImpl extends StatementImpl implements PrintStatement {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.PRINT_STATEMENT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRINT_STATEMENT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.PRINT_STATEMENT__TEXT:
				return getText();
		}
